...
namespace StringAndListOperations
{
	public class GenerateEmailTemplates
	{
		...
		public string GenerateMarketingEmailTemplate(string[] names)
		{
			...
			foreach (string name in names)
			{
				...
				newTemplate = newTemplate.Replace("[product/service]", "Course");
				newTemplate = newTemplate.Replace("[code]", "SMX80");
				newTemplate = newTemplate.Replace("[Your Name]", "Filip");
